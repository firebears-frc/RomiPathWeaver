...
public class RobotContainer {
  ...
  public RobotContainer(Trajectory pathWeaveTrajectory) {
    // Configure the button bindings
    configureButtonBindings(pathWeaveTrajectory);
  }
   ...
   */
  private Command generateRamseteCommand(Trajectory pathWeaveTrajectory) {
    ...
    m_drivetrain.resetOdometry(pathWeaveTrajectory.getInitialPose());

    // Set up a sequence of commands
    // First, we want to reset the drivetrain odometry
    return new InstantCommand(() -> m_drivetrain.resetOdometry(pathWeaveTrajectory.getInitialPose()), m_drivetrain)
   ...
   */
  private void configureButtonBindings(Trajectory pathWeaveTrajectory) {
    ...
    m_chooser.setDefaultOption("Ramsete Trajectory", generateRamseteCommand(pathWeaveTrajectory));
